    ...
    try:
        ...
        for name in category_names:
            ...
            if not category:
                ...
                category.slug = slugify(name)  # 确保设置 slug
        ...
        for i in range(200):
            ...
            comment = Comment(
                ...
                author=admin,
                post=post,
                created_at=fake.date_time_between(start_date=post.created_at),
                is_approved=random.choice([True, True, True, False])  # 75%概率通过审核
            )
